    ...
    <div class="row mb-3">
      <div class="col-12 mb-4">
        <div class="secondaryWrapper">
          <h2 class="secondaryTitle">Rejected Vendor Listing</h2>
        </div>
      </div>
      <div class="col-12">
      ...
      <div class="col-12">
        <div class="table-responsive">
          <table class="table table-borderless customTable">
            <thead>
              <tr>
                <th v-for="(heading, index) in RejectedVendorHead" :key="index">
                  {{ heading }}
                </th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="(item, index) in RejectedVendorListing" :key="index">
                <td>{{ index + 1 }}</td>
                <td>{{ item.id }}</td>
