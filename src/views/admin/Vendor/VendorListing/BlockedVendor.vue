<template>
  <div class="container-fluid">
    ...
    <div class="row mb-3">
      <div class="col-12 mb-4">
        <div class="secondaryWrapper">
          <h2 class="secondaryTitle">Blocked Vendors</h2>
        </div>
      </div>
      <div class="col-12">
      ...
      <div class="col-12">
        <div class="table-responsive">
          <table class="table table-borderless customTable">
            <thead>
              <tr>
                <th v-for="(heading, index) in BlockedVendorHead" :key="index">
                  {{ heading }}
                </th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="(item, index) in BlockedVendorListing" :key="index">
                <td>{{ index + 1 }}</td>
                <td>{{ item.id }}</td>
                <td>{{ item.vednorname }}</td>
                <td>{{ item.email }}</td>
                <td>{{ item.date }}</td>
                <td>
                  <div class="remove-box">
                    ...
                    >
                      ...
                      <b-dropdown-item-button
                        class="notBtn"
                        @click="$bvModal.show('unblockVendor')"
                      >
                        <div class="dropdownContent">
                          <div class="d-flex align-items-center">
                            <div class="mediaLeft">
    ...
    <b-modal id="unblockVendor" centered hide-footer hide-header>
      <div class="customModal">
        <div class="modalHeader">
          <button class="closeModal" @click="$bvModal.hide('unblockVendor')">
        ...
        <div class="modalBody">
          <div class="modalContent text-center">
            ...
            />
            <h2 class="modalHeading">Unblock Vendor</h2>
            <p class="modalText">Are you sure you want to unblock this Vendor?</p>
            <div class="modalForm my-4">
              <BaseButton
                ...
                @click="
                  $bvModal.hide('unblockVendor');
                  $bvModal.show('unblockVendor2');
                "
              />
              <BaseButton
                type="button"
                ...
                @click="$bvModal.hide('unblockVendor')"
              />
            </div>
          </div>
        </div>
    ...
    <BaseModal
      modalId="unblockVendor2"
      :modalSuccess="true"
      modalText="Vendor ABC has been Unblocked."
      btnText="Ok"
    />
